...
export default function AnaliticasPage() {
  ...
  // Por universidade (top 8) — inclui finalistas
  ...
  // Finalistas por universidade
  const porUniFinalista: Record<string, number> = {};
  estudantes
    .filter(e => e.nivel === 'Finalista' && e.universidade?.trim())
  ...
  // Finalistas por curso
  const porCursoFinalista: Record<string, number> = {};
  estudantes
    .filter(e => e.nivel === 'Finalista' && e.curso?.trim())
  ...
  return (
    <div className="p-6 lg:p-8 animate-fade-in">
      ...
      {/* Linha — Ano Universidade + Curso Universidade */}
      <div className="grid lg:grid-cols-2 gap-6 mb-6">
      ...
      <div className="bg-amber-50 border border-amber-100 rounded-2xl p-5 mb-6">
        <div className="flex items-center gap-2 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">{finalistas} estudante{finalistas !== 1 ? 's' : ''} já concluíram a universidade</p>
          </div>
        </div>
